...
final class Day4Tests: XCTestCase {
    func testDay4Part1Example() throws {
        ...
        // When
        let score = findFirstWinningBoard(for: input)
    ...
    func testDay4Part1() throws {
        print("Day 4 Part 1:", findFirstWinningBoard(for: input))
    }
    ...
    func testDay4Part2Example() throws {
        ...
        // When
        let score = findLastWinningBoard(for: input)
    ...
    func testDay4Part2() throws {
        print("Day 4 Part 2:", findLastWinningBoard(for: input))
    }
}
